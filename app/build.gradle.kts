...
android {
    ...
    val configuredVersionName = providers.gradleProperty("foldstandVersionName").orElse("1.5.1")
    val configuredVersionCode = providers.gradleProperty("foldstandVersionCode").orElse("10501")
