...
android {
    ...
    val configuredVersionName = providers.gradleProperty("foldstandVersionName").orElse("1.7.0")
    val configuredVersionCode = providers.gradleProperty("foldstandVersionCode").orElse("10700")
